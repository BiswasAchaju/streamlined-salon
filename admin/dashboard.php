...
<html>
<head>
<title>Streamlined Salon Management System | Admin Dashboard</title>
...
while ($row = mysqli_fetch_array($query6)) {
 ...
 ?>
						...
						<div class="stats-right">
							<label> <?php echo $todysale ? $todysale : 0; ?></label>
						</div>
						<div class="clearfix"> </div>	
					</div>
					<div class="clearfix"> </div>	
...
$query7 = mysqli_query($con, "select tblinvoice.ServiceId as ServiceId, tblservices.Cost
 from tblinvoice 
 join tblservices  on tblservices.ID=tblinvoice.ServiceId where date(PostingDate)=DATE_SUB(CURDATE(), INTERVAL 1 DAY);");
while ($row7 = mysqli_fetch_array($query7)) {
 ...
 ?>
						...
						<div class="stats-right">
							<label> <?php echo $yesterdaysale ? $yesterdaysale : 0; ?></label>
						</div>
						<div class="clearfix"> </div>	
					</div>
					<div class="col-md-4 widget states-mdl">
...
while ($row8 = mysqli_fetch_array($query8)) {
 ...
 ?>
						...
						<div class="stats-right">
							<label> <?php echo $tseven ? $tseven : 0; ?></label>
						</div>
						<div class="clearfix"> </div>	
					</div>
					<div class="col-md-4 widget states-last">
...
while ($row9 = mysqli_fetch_array($query9)) {
 ...
 ?>
						...
						<div class="stats-right">
							<label> <?php echo $totalsale ? $totalsale : 0; ?></label>
						</div>
						<div class="clearfix"> </div>	
					</div>
					<div class="clearfix"> </div>	
