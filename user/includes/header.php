...
$query = mysqli_query($con, "SELECT FullName FROM tblusers WHERE ID='$userid'");
    ...
    <div class="header-left">
        ...
        <div class="logo">
            <a href="user_dashboard.php">
                <h1>Streamlined Salon Management</h1>
                <span>UserPanel</span>
            </a>
        </div>
        <!--//logo-->
    ...
    <div class="header-right">
        <div class="profile_details_left">
            ...
            <ul class="nofitications-dropdown">
                <?php
                $ret1 = mysqli_query($con, "SELECT ID, Name FROM tblappointment WHERE UserId='$userid' AND Status=' '");
            ...
            <ul>
                <li class="dropdown profile_details_drop">
                    ...
                    <ul class="dropdown-menu drp-mnu">
                        <li> <a href="user-settings.php"><i class="fa fa-cog"></i> Settings</a> </li>
